// // app/license-application/page.jsx
// "use client";
    ...
    <div className='min-h-screen mt-20 bg-white text-gray-900'>
      <div className='container mx-auto px-4 py-8'>
        ...
        <div className='text-center mt-4'>
          ...
          <p className='text-sm text-gray-500'>
            Service: {form.service_name} ({form.duration}) - ₦
        ...
        >
          ...
          <div>
            ...
            >
              ...
              <option value='C'>
                C - Motor vehicle of less than 3 tonnes gross weight
              </option>
              <option value='D'>
                D - Motor vehicle other than motor cycle
              </option>
              <option value='E'>E - Motor vehicle (not articulated)</option>
              <option value='F'>F - Agricultural machines and tractors</option>
              <option value='G'>G - Articulated vehicles</option>
          ...
          <div className='text-center'>
            <button
              type='submit'
              disabled={loading}
              className={`rounded-xl px-6 py-3 text-white font-medium shadow-md transition ${
