...
// import ServiceCard from "@/components/ServiceCardSpareParts";
...
//       <ServiceCard key={service.id} service={service} selectedId={selectedId} />
//       ))}
//       </div>
...
export default function SpareParts() {
  ...
  // Filter spare parts based on query
