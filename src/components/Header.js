...
//               ) : (
//                 <Link
//                   href={user.role ? "/ag-dashboard" : "/dashboard_form"}
      ...
      <nav className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center">
          <Image
            ...
            className="h-12 w-auto"
          />
          <span className="ml-2 text-sm text-gray-600 italic">Vehiculars</span>
        </Link>
          ...
          <div className="flex flex-col space-y-2 pt-2 border-t">
            {userSession ? (
              userSession.mustChangePassword ? (
                ...
                <Link
                  href={
                    userSession.isAgent ? "/ag-dashboard" : "/dashboard_form"
                  }
                  className="px-4 py-2 text-center text-white bg-blue-600 rounded-full hover:bg-blue-700"
                >
                  My Account
