...
{/* <LoanManager
  currentLoans={[
    { id: "LN001", totalPaid: 50000, totalAmount: 100000, disbursedOn: "12 Aug 2023" },
    { id: "LN002", totalPaid: 75000, totalAmount: 75000, disbursedOn: "05 Jul 2023" },
  ]}
  completedLoans={[
    { id: "LN100", disbursedOn: "01 Jun 2023", amount: "₦250,000" },
    { id: "LN101", disbursedOn: "15 May 2023", amount: "₦120,000" },
  ]}
/> */}
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      ...
      <div className="text-center py-4">
        <h2 className="text-lg font-semibold text-gray-900">Manage your loans</h2>
      </div>
      ...
      <div className="flex justify-center space-x-6 border-b mb-6">
        ...
        >
          <i className="fas fa-calendar mr-2" /> Current
        </button>
        <button
        ...
        >
          <i className="fas fa-history mr-2" /> Completed
        </button>
      </div>
        ...
        <>
          {currentLoans.length === 0 ? (
            <div className="text-center text-gray-500 py-16">
              <i className="fas fa-folder-open fa-3x mb-4 text-gray-400" />
              <p className="text-sm italic">No outstanding loans</p>
            </div>
          ) : (
            <div className="space-y-6 mb-6">
              <h3 className="text-sm font-semibold text-gray-800">Current loans</h3>
      ...
      {activeTab === "completed" && (
        <>
          {completedLoans.length === 0 ? (
            <div className="text-center text-gray-500 py-16">
              <i className="fas fa-folder-open fa-3x mb-4 text-gray-400" />
              <p className="text-sm italic">No completed loans</p>
            </div>
          ) : (
            <div className="space-y-4 mb-6">
              <h3 className="text-sm font-semibold text-gray-800">Completed loans</h3>
                ...
                {completedLoans.map((loan) => (
                  ...
                  >
                    ...
                    <div className="flex justify-between text-sm mb-2">
                      ...
                      <span className="font-semibold text-blue-600">{loan.amount}</span>
                    </div>
                    <div className="text-right">
                      <Link
                        href={`/service-history?batch_id=${loan.id}`}
